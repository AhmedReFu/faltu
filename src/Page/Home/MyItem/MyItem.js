...
const MyItem = () => {
    ...
    useEffect(() => {
        const getMyItem = async () => {
            ...
            const url = `https://desolate-hollows-13177.herokuapp.com/myItem?email=${email}`;
    ...
    const handleDeleteBtn = (id) => {
        ...
        if (proceed) {
            const url = `https://desolate-hollows-13177.herokuapp.com/myItem/${id}`
            fetch(url, {
                method: 'DELETE'
            })
                .then(res => res.json())
    ...
    return (
        <div className='my-item-container container'>
