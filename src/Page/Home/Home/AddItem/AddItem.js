...
const AddItem = () => {
    ...
    const handleAddItems = (event) => {
        ...
        axios.post('https://desolate-hollows-13177.herokuapp.com/addItem', addItem)
            .then(response => {
        ...
        <div className='add-main'>
            <div className='add-container'>
                ...
                <form className='p-5' onSubmit={handleAddItems} >
                    ...
                    <input className='w-100 mb-2' name="product_name" id="" placeholder='enter product name' required />
